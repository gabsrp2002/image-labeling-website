      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            A powerful platform for managing image labeling tasks. Admins can assign images and tasks, while labelers can efficiently complete annotation work.
          </p>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Admin Dashboard</h3>
                  <p className="mt-5 text-base text-gray-500">
                    Manage image datasets, create labeling tasks, and monitor progress with our comprehensive admin interface.
                  </p>
                </div>
              </div>
            </div>
